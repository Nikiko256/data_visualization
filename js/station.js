          ...
          <div class="info-grid">
            ...
            <div class="info-card">
              ...
              <p>
                ...
                48ωρες, εβδομαδιαίες, μηνιαίες, ετήσιες κ.ο.κ. Ταυτόχρονα, για κάθε χρονικό διάστημα, εμφανίζεται ο μέσος όρος των μετρήσεων για το συγκεκριμένο διάστημα, 
                ώστε ο χρήστης να έχει μια γενική εικόνα για τις περιβαλλοντικές συνθήκες που επικρατούν.
              </p>
            </div>
            ...
            <div class="info-card">
              ...
              <p>
                Για κάθε κόμβο, παρέχεται στον χρήστη η δυνατότητα διεξαγωγής δεδομένων σε μορφή CSV, για να μπορεί να τα αξιοποιήσει όπως επιθυμεί, 
                πχ για ανάλυση δεδομένων σε εργαλεία ανάλυσης δεδομένων (Excel, Python, R).
              </p>
            </div>
